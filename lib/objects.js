...
export class Objects {
    ...
    static requireFields(obj, fields = [], message = undefined) {
        if (!fields || fields.length == 0 ) throw new Error("Fields are not declared");
        fields.forEach(f => {
            Objects.requireNonNull(obj[f], message ?? "Missing field " + f)
        })
        return obj;
    }
